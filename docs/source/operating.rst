[cybersecurity-160-5567] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecurity-160-5567] container is NOT running**.

.. tip::
   You must have your [cybersecurity-160-5567] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/anupamPDL/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35259  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='anupampDL'  \-\-env DOCKERUSERNAME='anupampdl'  \-\-env MQTTUSERNAME='apmpdl'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. code-block::
   ...
   docker run -d -p 33347:33347 -p 58911:58911 -p 40429:40429 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=cybersecurity-160-5567 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecurity-160-5567 \
          --env GITUSERNAME=anupampDL \
          --env GITREPOURL=https://github.com/anupamPDL/raspberrypi \
          --env SOLUTIONEXTERNALPORT=33347 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=58911  \
          --env SOLUTIONVIPERVIZPORT=40429 \
...
It can be accessed by entering: http://localhost:58911
...
.. important::
   http://localhost:40429/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:40429/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:40429/<html file>
...
[cybersecurity-160-5567] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/anupampDL/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecurity-160-5567
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecurity-160-5567
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=33347, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44827, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35863, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39993, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42047, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44413, HPDEHOST=127.0.1.1, HPDEPORT=39887, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=32913

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9777-cybersecurity-160-5567,solution_preprocessing_ai_mqtt_dag-cybersecurity-160-5567, python-preprocess-5913-cybersecurity-160-5567,solution_preprocessing_ai_mqtt_dag-cybersecurity-160-5567, python-ai-8783-cybersecurity-160-5567,solution_preprocessing_ai_mqtt_dag-cybersecurity-160-5567, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
