...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/anupamPDL/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40101  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='anupampDL'  \-\-env DOCKERUSERNAME='anupampdl'  \-\-env MQTTUSERNAME='apmpdl'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   solution_preprocessing_ai_restapi_dag-cybersecurity-160-5567
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=35183, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45647, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39767, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39491, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41415, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35395, HPDEHOST=127.0.1.1, HPDEPORT=33475, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42499

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1989-cybersecurity-160-5567,solution_preprocessing_ai_restapi_dag-cybersecurity-160-5567, python-preprocess-6138-cybersecurity-160-5567,solution_preprocessing_ai_restapi_dag-cybersecurity-160-5567, python-ai-7947-cybersecurity-160-5567,solution_preprocessing_ai_restapi_dag-cybersecurity-160-5567, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
